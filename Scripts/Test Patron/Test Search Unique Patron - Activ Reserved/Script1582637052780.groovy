...
WebUI.click(findTestObject('Capture Object Patron/Page_nightlyno - Axiell Quria/h2_PatronName'))
...
WebUI.verifyElementText(findTestObject('Capture Object Patron Search/Page_nightlyno - Axiell Quria/div_AktiveReserveringer'), 'Aktive reserveringer (1)')
