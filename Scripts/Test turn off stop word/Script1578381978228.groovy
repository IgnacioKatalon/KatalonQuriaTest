...
WebUI.waitForElementVisible(findTestObject('test manuel objecter 2/Page_nightlyno - Axiell Quria/div_Resultater'), 30)

WebUI.click(findTestObject('test manuel objecter 2/Page_nightlyno - Axiell Quria/div_Resultater'))

WebUI.verifyElementText(findTestObject('test manuel objecter 2/Page_nightlyno - Axiell Quria/div_Resultater'), 'Resultater: 8')
